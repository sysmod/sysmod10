...
public class Ulno_makes_a_move_from_house_6Test extends TestCase
{
    ...
    * Ulno_makes_a_move_from_house_6Test ------------------------> Store
    *           test               artjomStore
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Ulno_makes_a_move_from_house_6Test withArtjomStore (Store value)
   {
    ...
    * Ulno_makes_a_move_from_house_6Test ------------------------> HumanPlayer
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Ulno_makes_a_move_from_house_6Test withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         JavaSDM.ensure ( pit11.getSeeds () == 9, "attribute condition seeds == 9" );
    ...
    * Ulno_makes_a_move_from_house_6Test ------------------------> Pit
    *           test               pit10
    * </pre>
    */
   ...
   @Property( name = PROPERTY_PIT10 )
   public Ulno_makes_a_move_from_house_6Test withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Ulno_makes_a_move_from_house_6Test withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Ulno_makes_a_move_from_house_6Test withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Ulno_makes_a_move_from_house_6Test withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Ulno_makes_a_move_from_house_6Test withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Ulno_makes_a_move_from_house_6Test withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Ulno_makes_a_move_from_house_6Test withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Ulno_makes_a_move_from_house_6Test withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Ulno_makes_a_move_from_house_6Test withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Ulno_makes_a_move_from_house_6Test withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Ulno_makes_a_move_from_house_6Test withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Ulno_makes_a_move_from_house_6Test withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void testUlno_makes_a_move_from_house_6 ()
   {
      boolean fujaba__Success = false;
    ...
    * <pre>
    *           0..1     object_turn     0..1
    * Ulno_makes_a_move_from_house_6Test ------------------------> Turn
    *           test               turn
    * </pre>
    */
   ...
   @Property( name = PROPERTY_TURN )
   public Ulno_makes_a_move_from_house_6Test withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Ulno_makes_a_move_from_house_6Test withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Ulno_makes_a_move_from_house_6Test withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
    ...
    * Ulno_makes_a_move_from_house_6Test ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Ulno_makes_a_move_from_house_6Test withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
