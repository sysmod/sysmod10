...
public class Artjom_makes_a_move_from_house_12Test extends TestCase
{
    ...
    * Artjom_makes_a_move_from_house_12Test ------------------------> Player
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Artjom_makes_a_move_from_house_12Test withArtjom (Player value)
   {
      setArtjom (value);
      return this;
   }
    ...
    * Artjom_makes_a_move_from_house_12Test ------------------------> GameBoard
    *           test               board
    * </pre>
    */
   ...
   @Property( name = PROPERTY_BOARD )
   public Artjom_makes_a_move_from_house_12Test withBoard (GameBoard value)
   {
      setBoard (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Artjom_makes_a_move_from_house_12Test withUlno (Player value)
   {
      setUlno (value);
      return this;
   }
