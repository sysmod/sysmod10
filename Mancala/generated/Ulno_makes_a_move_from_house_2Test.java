...
public class Ulno_makes_a_move_from_house_2Test extends TestCase
{
    ...
    * Ulno_makes_a_move_from_house_2Test ------------------------> Store
    *           test               artjomStore
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Ulno_makes_a_move_from_house_2Test withArtjomStore (Store value)
   {
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         JavaSDM.ensure ( pit7.getSeeds () == 2, "attribute condition seeds == 2" );

         // attribute condition seeds == 3
         JavaSDM.ensure ( ulnoStore.getSeeds () == 3, "attribute condition seeds == 3" );

         // attribute condition seeds == 3
         JavaSDM.ensure ( pit12.getSeeds () == 3, "attribute condition seeds == 3" );

         // attribute condition seeds == 4
         JavaSDM.ensure ( pit1.getSeeds () == 4, "attribute condition seeds == 4" );

         // attribute condition seeds == 5
         JavaSDM.ensure ( pit3.getSeeds () == 5, "attribute condition seeds == 5" );
    ...
    * Ulno_makes_a_move_from_house_2Test ------------------------> Pit
    *           test               pit10
    * </pre>
    */
   ...
   @Property( name = PROPERTY_PIT10 )
   public Ulno_makes_a_move_from_house_2Test withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Ulno_makes_a_move_from_house_2Test withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Ulno_makes_a_move_from_house_2Test withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Ulno_makes_a_move_from_house_2Test withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Ulno_makes_a_move_from_house_2Test withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Ulno_makes_a_move_from_house_2Test withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Ulno_makes_a_move_from_house_2Test withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Ulno_makes_a_move_from_house_2Test withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Ulno_makes_a_move_from_house_2Test withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Ulno_makes_a_move_from_house_2Test withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Ulno_makes_a_move_from_house_2Test withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Ulno_makes_a_move_from_house_2Test withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void setUp ()
   {
      ...
      try 
      {
         ...
         // create link owns from artjomStore to artjom
         artjomStore.setPlayer (artjom);
         ...
         // create link has from ulno to turn
         ulno.setTurn (turn);
   ...
   public void testUlno_makes_a_move_from_house_2 ()
   {
      boolean fujaba__Success = false;
    ...
    * <pre>
    *           0..1     object_turn     0..1
    * Ulno_makes_a_move_from_house_2Test ------------------------> Turn
    *           test               turn
    * </pre>
    */
   ...
   @Property( name = PROPERTY_TURN )
   public Ulno_makes_a_move_from_house_2Test withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Ulno_makes_a_move_from_house_2Test withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
    ...
    * Ulno_makes_a_move_from_house_2Test ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Ulno_makes_a_move_from_house_2Test withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
