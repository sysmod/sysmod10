...
public class Ulno_makes_a_move_from_house_2Test extends TestCase
{
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         JavaSDM.ensure ( artjomStore.getSeeds () == 4, "attribute condition seeds == 4" );
    ...
    * Ulno_makes_a_move_from_house_2Test ------------------------> GameBoard
    *           test               board
    * </pre>
    */
   ...
   @Property( name = PROPERTY_BOARD )
   public Ulno_makes_a_move_from_house_2Test withBoard (GameBoard value)
   {
      setBoard (value);
      return this;
   }
