...
public class Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest extends TestCase
{
    ...
    * Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest ------------------------> Store
    *           test               artjomStore
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withArtjomStore (Store value)
   {
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         JavaSDM.ensure ( artjomStore.getSeeds () == 2, "attribute condition seeds == 2" );

         // attribute condition seeds == 2
         JavaSDM.ensure ( pit5.getSeeds () == 2, "attribute condition seeds == 2" );

         // attribute condition seeds == 3
         JavaSDM.ensure ( pit4.getSeeds () == 3, "attribute condition seeds == 3" );

         // attribute condition seeds == 4
         JavaSDM.ensure ( pit7.getSeeds () == 4, "attribute condition seeds == 4" );

         // attribute condition seeds == 6
         JavaSDM.ensure ( pit12.getSeeds () == 6, "attribute condition seeds == 6" );

         // attribute condition seeds == 7
         JavaSDM.ensure ( pit6.getSeeds () == 7, "attribute condition seeds == 7" );

         // attribute condition seeds == 9
         JavaSDM.ensure ( ulnoStore.getSeeds () == 9, "attribute condition seeds == 9" );
    ...
    * Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest ------------------------> Pit
    *           test               pit10
    * </pre>
    */
   ...
   @Property( name = PROPERTY_PIT10 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void testUlno_makes_a_move_from_pit_2_and_gets_a_new_move ()
   {
      boolean fujaba__Success = false;
    ...
    * <pre>
    *           0..1     object_turn     0..1
    * Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest ------------------------> Turn
    *           test               turn
    * </pre>
    */
   ...
   @Property( name = PROPERTY_TURN )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Ulno_makes_a_move_from_pit_2_and_gets_a_new_moveTest withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
