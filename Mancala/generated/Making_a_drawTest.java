...
public class Making_a_drawTest extends TestCase
{
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Making_a_drawTest withArtjomStore (Store value)
   {
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Making_a_drawTest withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // attribute condition seeds == 18
         JavaSDM.ensure ( artjomStore.getSeeds () == 18, "attribute condition seeds == 18" );

         // attribute condition seeds == 18
         JavaSDM.ensure ( ulnoStore.getSeeds () == 18, "attribute condition seeds == 18" );
   ...
   @Property( name = PROPERTY_PIT10 )
   public Making_a_drawTest withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Making_a_drawTest withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Making_a_drawTest withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Making_a_drawTest withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Making_a_drawTest withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Making_a_drawTest withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Making_a_drawTest withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Making_a_drawTest withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Making_a_drawTest withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Making_a_drawTest withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Making_a_drawTest withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Making_a_drawTest withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_TURN )
   public Making_a_drawTest withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Making_a_drawTest withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Making_a_drawTest withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
    ...
    * Making_a_drawTest ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Making_a_drawTest withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
