...
public class Ulno_wins_the_gameTest extends TestCase
{
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Ulno_wins_the_gameTest withArtjomStore (Store value)
   {
    ...
    * Ulno_wins_the_gameTest ------------------------> HumanPlayer
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Ulno_wins_the_gameTest withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // attribute condition seeds == 15
         JavaSDM.ensure ( artjomStore.getSeeds () == 15, "attribute condition seeds == 15" );

         // attribute condition seeds == 21
         JavaSDM.ensure ( ulnoStore.getSeeds () == 21, "attribute condition seeds == 21" );
   ...
   @Property( name = PROPERTY_PIT10 )
   public Ulno_wins_the_gameTest withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Ulno_wins_the_gameTest withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Ulno_wins_the_gameTest withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Ulno_wins_the_gameTest withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Ulno_wins_the_gameTest withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Ulno_wins_the_gameTest withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Ulno_wins_the_gameTest withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Ulno_wins_the_gameTest withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Ulno_wins_the_gameTest withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Ulno_wins_the_gameTest withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Ulno_wins_the_gameTest withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Ulno_wins_the_gameTest withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void testUlno_wins_the_game ()
   {
      boolean fujaba__Success = false;
   ...
   @Property( name = PROPERTY_TURN )
   public Ulno_wins_the_gameTest withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Ulno_wins_the_gameTest withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Ulno_wins_the_gameTest withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
    ...
    * Ulno_wins_the_gameTest ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Ulno_wins_the_gameTest withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
