...
public class Artjom_wins_the_game_againTest extends TestCase
{
    ...
    * Artjom_wins_the_game_againTest ------------------------> Store
    *           test               artjomStore
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Artjom_wins_the_game_againTest withArtjomStore (Store value)
   {
    ...
    * Artjom_wins_the_game_againTest ------------------------> HumanPlayer
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Artjom_wins_the_game_againTest withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // check link is winner from visitor to artjom
         JavaSDM.ensure (artjom.equals (visitor.getWinner ()), "check link is winner from visitor to artjom");
         ...
         // attribute condition seeds == 29
         JavaSDM.ensure ( artjomStore.getSeeds () == 29, "attribute condition seeds == 29" );

         // attribute condition seeds == 7
         JavaSDM.ensure ( ulnoStore.getSeeds () == 7, "attribute condition seeds == 7" );
    ...
    * Artjom_wins_the_game_againTest ------------------------> Pit
    *           test               pit10
    * </pre>
    */
   ...
   @Property( name = PROPERTY_PIT10 )
   public Artjom_wins_the_game_againTest withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Artjom_wins_the_game_againTest withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Artjom_wins_the_game_againTest withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Artjom_wins_the_game_againTest withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Artjom_wins_the_game_againTest withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Artjom_wins_the_game_againTest withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Artjom_wins_the_game_againTest withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Artjom_wins_the_game_againTest withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Artjom_wins_the_game_againTest withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Artjom_wins_the_game_againTest withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Artjom_wins_the_game_againTest withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Artjom_wins_the_game_againTest withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void testArtjom_wins_the_game_again ()
   {
      boolean fujaba__Success = false;
    ...
    * <pre>
    *           0..1     object_turn     0..1
    * Artjom_wins_the_game_againTest ------------------------> Turn
    *           test               turn
    * </pre>
    */
   ...
   @Property( name = PROPERTY_TURN )
   public Artjom_wins_the_game_againTest withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Artjom_wins_the_game_againTest withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Artjom_wins_the_game_againTest withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
    ...
    * Artjom_wins_the_game_againTest ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Artjom_wins_the_game_againTest withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
