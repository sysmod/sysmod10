...
public class Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest extends TestCase
{
    ...
    * Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest ------------------------> Store
    *           test               artjomStore
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM_STORE )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withArtjomStore (Store value)
   {
    ...
    * Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest ------------------------> HumanPlayer
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // attribute condition seeds == 1
         JavaSDM.ensure ( pit11.getSeeds () == 1, "attribute condition seeds == 1" );

         // attribute condition seeds == 1
         JavaSDM.ensure ( pit12.getSeeds () == 1, "attribute condition seeds == 1" );

         // attribute condition seeds == 12
         JavaSDM.ensure ( artjomStore.getSeeds () == 12, "attribute condition seeds == 12" );

         // attribute condition seeds == 12
         JavaSDM.ensure ( ulnoStore.getSeeds () == 12, "attribute condition seeds == 12" );
         ...
         // attribute condition seeds == 3
         JavaSDM.ensure ( pit5.getSeeds () == 3, "attribute condition seeds == 3" );
    ...
    * Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest ------------------------> Pit
    *           test               pit10
    * </pre>
    */
   ...
   @Property( name = PROPERTY_PIT10 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit10 (Pit value)
   {
      setPit10 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT11 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit11 (Pit value)
   {
      setPit11 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT12 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit12 (Pit value)
   {
      setPit12 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT1 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit1 (Pit value)
   {
      setPit1 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT2 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit2 (Pit value)
   {
      setPit2 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT3 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit3 (Pit value)
   {
      setPit3 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT4 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit4 (Pit value)
   {
      setPit4 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT5 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit5 (Pit value)
   {
      setPit5 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT6 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit6 (Pit value)
   {
      setPit6 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT7 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit7 (Pit value)
   {
      setPit7 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT8 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit8 (Pit value)
   {
      setPit8 (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_PIT9 )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withPit9 (Pit value)
   {
      setPit9 (value);
      return this;
   }
   ...
   public void testArtjom_makes_a_move_from_pit_8_and_gets_a_new_move ()
   {
      boolean fujaba__Success = false;
    ...
    * <pre>
    *           0..1     object_turn     0..1
    * Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest ------------------------> Turn
    *           test               turn
    * </pre>
    */
   ...
   @Property( name = PROPERTY_TURN )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withTurn (Turn value)
   {
      setTurn (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO_STORE )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withUlnoStore (Store value)
   {
      setUlnoStore (value);
      return this;
   }
   ...
   @Property( name = PROPERTY_ULNO )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
    ...
    * Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest ------------------------> CheckWinVisitor
    *           test               visitor
    * </pre>
    */
   ...
   @Property( name = PROPERTY_VISITOR )
   public Artjom_makes_a_move_from_pit_8_and_gets_a_new_moveTest withVisitor (CheckWinVisitor value)
   {
      setVisitor (value);
      return this;
   }
