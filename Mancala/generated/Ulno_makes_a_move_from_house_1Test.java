...
public class Ulno_makes_a_move_from_house_1Test extends TestCase
{
    ...
    * Ulno_makes_a_move_from_house_1Test ------------------------> HumanPlayer
    *           test               artjom
    * </pre>
    */
   ...
   @Property( name = PROPERTY_ARTJOM )
   public Ulno_makes_a_move_from_house_1Test withArtjom (HumanPlayer value)
   {
      setArtjom (value);
      return this;
   }
   ...
   public void assertStep1 ()
   {
      ...
      try 
      {
         ...
         // attribute condition seeds == 10
         JavaSDM.ensure ( pit12.getSeeds () == 10, "attribute condition seeds == 10" );

         // attribute condition seeds == 15
         JavaSDM.ensure ( ulnoStore.getSeeds () == 15, "attribute condition seeds == 15" );
   ...
   @Property( name = PROPERTY_ULNO )
   public Ulno_makes_a_move_from_house_1Test withUlno (HumanPlayer value)
   {
      setUlno (value);
      return this;
   }
